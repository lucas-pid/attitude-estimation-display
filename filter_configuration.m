function cs = filter_configuration()
% MATLAB function for configuration set generated on 29-Apr-2025 19:10:21
...
cs.set_param('Name', 'Filter Configuration'); % Name
...
cs.set_param('Solver', 'ode1');   % Solver

% Solver
cs.set_param('SolverName', 'ode1');   % Solver
cs.set_param('SolverType', 'Fixed-step');   % Type
cs.set_param('SampleTimeConstraint', 'Unconstrained');   % Periodic sample time constraint
cs.set_param('FixedStep', 'sim.sample_time_s');   % Fixed-step size (fundamental sample time)
...
cs.set_param('ProdHWDeviceType', 'Intel->x86-32 (Windows32)');   % Production device vendor and type
